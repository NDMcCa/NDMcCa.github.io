...
export default function Home() {
  ...
  return (
    <main id="page" className="overflow-y-scroll max-lg:snap-y max-lg:snap-mandatory bg-neutral-100 dark:bg-neutral-950 transition-colors ease-in-out duration-500 h-screen w-screen" >
            ...
            <div className="flex flex-col items-center justify-center gap-y-10 py-8">
              <div className="flex flex-row flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12">
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'Python 3' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'Java' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'JavaScript' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'TypeScript' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'C++' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
              ...
              <div className="flex flex-row flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12">
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'React' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'Next.js' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'Svelte' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'Tailwind CSS' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'Docker' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {hoveredIcon === 'MySQL' && <span className="absolute top-full mt-2 text-sm text-black dark:text-neutral-200">{hoveredIcon}</span>}
                </div>
              </div>
            </div>
