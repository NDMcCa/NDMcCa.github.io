        ...
        <section className="snap-center max-lg:snap-always flex flex-col 2xl:flex-row items-center justify-start w-full h-screen transition-colors ease-in-out duration-500 bg-neutral-100 pt-20 md:pt-28 dark:bg-neutral-950">
          ...
          bg-neutral-100 dark:bg-neutral-950">
            ...
            <div className="flex flex-col 2xl:w-full 2xl:space-y-10">
              <h1 className="text-3xl md:text-5xl xl:text-7xl text-black dark:text-neutral-200 m-auto text-center transition-colors ease-in-out duration-500 px-2">Nicholas McCamis</h1>
              <div className="flex flex-row items-center justify-center w-full h-fit space-x-3 md:space-x-6 xl:space-x-10 px-4 py-4">
            ...
            <button onClick={download} className="w-30 h-24 md:w-48 md:h-40 md:text-xl lg:w-52 lg:h-20 lg:text-2xl xl:w-56 xl:h-20 xl:text-3xl 
