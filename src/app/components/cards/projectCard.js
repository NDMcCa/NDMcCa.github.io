                ...
                <div className="flex flex-col px-2 w-full text-xs sm:text-sm md:text-lg gap-y-2">
                    <div className="flex flex-row gap-x-2 gap-y-2">
                        ...
                        {props.icons.map((icon, index) => (
                            <Image key={index} src={icon} alt="" className="h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10 lg:h-10 lg:w-10 xl:h-10 xl:w-10 text-themed-navy dark:text-themed-light invert dark:invert-0" />
                        ))}
                        </div>
                    </div>
