...
function ClockCard (){ 
    ...
    return (
        <div onClick={() => handleNewTab("https://en.wikipedia.org/wiki/Binary_clock")} className="flex flex-col sm:flex-row w-full h-fit shadow-md items-center overflow-hidden bg-neutral-800 dark:bg-themed-mid outline outline-2 outline-neutral-400 dark:outline-themed-light cursor-pointer
