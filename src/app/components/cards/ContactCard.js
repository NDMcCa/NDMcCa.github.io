...
const ContactCard = () => {
    return(
        <div className="flex flex-row h-80 mx-20 w-full items-center justify-center dark:bg-themed-dark outline outline-2 outline-neutral-400 dark:outline-themed-light rounded-xl overflow-hidden dark:bg-themed-mid">
                    <Image  src={osk} 
                            alt="A photo of me" 
                ...
                <div className="flex flex-col items-center justify-center gap-y-4 h-full w-fit md:w-1/2 transition-colors ease-in-out duration-500 border-l-2 border-neutral-400 dark:border-themed-light">
