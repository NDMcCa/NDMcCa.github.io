...
function BinClock() {
    ...
    return (
        <div>
            <div className="bg-neutral-950 dark:bg-neutral-800 w-fit h-fit flex transition-colors ease-in-out duration-500 shadow-md shadow-neutral-400 dark:shadow-black">
